...
//Утиліти(головна функція - отримання випадкового персонажа, відмінного від поточного)
...
const setGunmanPose = pose => {
    ...
    dom.gunman.className = `gunman ${cls} ${pose}`;//Таймери
};
...
function playerShootsGunman() {
    ...
    //Події (listeners) після перемоги
    scheduleTimer(() => {
